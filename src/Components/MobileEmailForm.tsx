				...
				<div className="wrap">
					<a
						onClick={() => analytics.logEvent('select_content', {
							content_type: 'social-media-icon',
							content_id: 'instagram'
						})}
						target="_blank"
						rel="noopener noreferrer"
						href="https://www.instagram.com/theandymag/">
						<div className="Instagram">
							{/* <img src="../assets/insta_mob.svg" alt="Instagram Icon" /> */}
							<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
								<g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
									<g id="iconfinder_social_media_social_media_logo_instagram_1907115" transform="translate(1.000000, 1.000000)" stroke={ darkMode ? '#FFFFFF' : '#334669' } strokeWidth="1.7">
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href="https://twitter.com/theandymag_">
						<div className="Twitter">
							<svg width="26px" height="22px" viewBox="0 0 26 22" version="1.1">
								<g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
									<g id="iconfinder_social_media_social_media_logo_twitter_1907088" transform="translate(1.000000, 1.000000)" stroke={ darkMode ? '#FFFFFF' : '#334669' } strokeWidth="1.7">
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href="https://www.snapchat.com/add/theandymag">
						<div className="Snapchat">
							<svg width="26px" height="24px" viewBox="0 0 26 24" version="1.1">
								<g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
									<g id="iconfinder_social_media_social_media_logo_snapchat_1907098" transform="translate(1.000000, 1.000000)" stroke={ darkMode ? '#FFFFFF' : '#334669' } strokeWidth="1.7">
					...
					<a
						...
						// onClick={() => analytics.logEvent('page_view')}
						target="_blank"
						rel="noopener noreferrer"
					...
					>
						<div className="Spotify">
							<svg width="26px" height="26px" viewBox="0 0 26 26" version="1.1">
								<g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
									<g id="iconfinder_social_media_social_media_logo_spotify_1907096" transform="translate(1.000000, 1.000000)" stroke={ darkMode ? '#FFFFFF' : '#334669' } strokeWidth="1.7">
